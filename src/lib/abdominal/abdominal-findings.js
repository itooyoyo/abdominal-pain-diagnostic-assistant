...
export const LOCATIONS = Object.freeze([['epigastric', '心窩部'], ['RUQ', '右上腹部'], ['LUQ', '左上腹部'], ['periumbilical', '臍周囲'], ['RLQ', '右下腹部'], ['LLQ', '左下腹部'], ['suprapubic', '下腹部正中'], ['generalized', '腹部全体'], ['right_flank', '右側腹部'], ['left_flank', '左側腹部'], ['back', '背部'], ['other', 'その他'], ['indeterminate', '判定困難']])
